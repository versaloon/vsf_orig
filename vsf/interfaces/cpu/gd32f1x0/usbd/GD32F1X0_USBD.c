...
struct interface_usbd_callback_t gd32f1x0_usbd_callback;
...
vsf_err_t gd32f1x0_usbd_init(int32_t int_priority)
{
	...
	if (gd32f1x0_interface_get_info(&gd32f1x0_info))
	{
		return VSFERR_FAIL;
	}
...
vsf_err_t gd32f1x0_usbd_ep_set_type(uint8_t idx, enum interface_usbd_eptype_t type)
{
	int8_t index;
