...
struct vsfhal_usbd_callback_t stm32_usbd_callback;
...
vsf_err_t stm32_usbd_ep_set_type(uint8_t idx, enum vsfhal_usbd_eptype_t type)
{
	int8_t index;
